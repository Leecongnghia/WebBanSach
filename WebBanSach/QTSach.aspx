  ...
  <hr />
    ...
    <div class="row">
         <div class="col-md-6">
               <div class="form-inline">
                   ...
                   <asp:Button ID="btTraCuu" runat="server" Text="Tra cứu" CssClass="btn btn-danger" />
               </div>
         </div>
    ...
    <asp:GridView ID="gvSach" runat="server" CssClass="table table-bordered mt-2" AutoGenerateColumns="False"
        ...
        <Columns>            
            ...
            <asp:ImageField DataImageUrlField="hinh" DataImageUrlFormatString="bia_sach/{0}" ReadOnly="true"
               ControlStyle-Font-Size="10px" HeaderStyle-Height="20px" HeaderText="Ảnh bìa" SortExpression="Hinh" />
